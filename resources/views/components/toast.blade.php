...
<div id="toast-component" class="flex @if($position=='top') top-16 @else bottom-5 @endif absolute right-4 items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow" role="alert"
