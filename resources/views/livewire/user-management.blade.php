<x-content-card  x-data="{show:false}">
    ...
    <x-button @click="show=true" type="button">open model</x-button>
    </div>
    <x-table>
        <x-thead>
            <tr>
    ...
    {{-- Modal create form --}}
    <div x-show="show" x-cloak class="absolute inset-0 flex items-center justify-center bg-gray-700 bg-opacity-50 pl-24 transition-opacity duration-2000 linear">
        <div class="w-full h-screen p-6 bg-white  transition-all duration-200 ease-out">
            ...
            <div class="my-4">
                <form>
                    <div class="flex justify-between items-center gap-4 w-1/3 mb-4">
            ...
            <div class="flex justify-between items-center gap-4 w-1/3">
