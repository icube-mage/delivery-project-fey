        ...
        <ul class="mt-5 space-y-2">
            ...
            <li>
                ...
                <a href="{{ route('menu.uploadfile') }}"
                    class="flex items-center p-2 text-white text-base font-medium rounded-lg hover:text-slate-700 dark:text-white hover:bg-green-500 dark:hover:bg-green-700 @if(Route::is('menu.uploadfile') || Route::is('menu.uploadfile.checkprice')) bg-green-500 @endif">
            ...
            <li>
                <a href="{{ route('menu.report') }}"
                    class="flex items-center p-2 text-base text-white font-medium rounded-lg hover:text-slate-700 dark:text-white hover:bg-green-500 dark:hover:bg-green-700 @if(Route::is('menu.report')) bg-green-500 @endif">
            ...
            <li>
                <a href="{{ route('menu.historicaldata') }}"
                    class="flex items-center p-2 text-base text-white font-medium rounded-lg hover:text-slate-700 dark:text-white hover:bg-green-500 dark:hover:bg-green-700 @if(Route::is('menu.historicaldata')) bg-green-500 @endif">
                    <svg class="w-6 h-6 text-white transition duration-75 dark:text-gray-700 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                ...
                <a href="{{ route('settings.configuration') }}"
                    class="flex items-center p-2 text-base text-white font-medium rounded-lg hover:text-slate-700  dark:text-white hover:bg-green-500 dark:hover:bg-green-700 @if(Route::is('settings.configuration')) bg-green-500 @endif">
                    <svg class="w-6 h-6 text-white transition duration-75 dark:text-gray-700 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
